...
public class GameActivity extends AppCompatActivity {
    ...
    private void selectStatistic(int statisticPosition) {
        ...
        CardInfo.Statistic statistic =
                game.getCurrentStatistic(statisticPosition);
    ...
    private void displayCurrentCard() {
        ...
        // Statistics
        CardInfo.Statistic statistic1 =
                currentCard.statistics[0];

        CardInfo.Statistic statistic2 =
                currentCard.statistics[1];

        CardInfo.Statistic statistic3 =
                currentCard.statistics[2];

        CardInfo.Statistic statistic4 =
                currentCard.statistics[3];

        CardInfo.Statistic statistic5 =
                currentCard.statistics[4];

        CardInfo.Statistic statistic6 =
                currentCard.statistics[5];
        ...
        TextView value6 =
                findViewById(R.id.value6);

        value6.setText(
                formatValue(statistic6.value)
        );
    }
